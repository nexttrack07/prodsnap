...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create prodsnap-eda6
  fly apps create prodsnap-eda6-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app prodsnap-eda6
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app prodsnap-eda6-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'prodsnap-eda6-staging' does not match app name in config file 'prodsnap-eda6'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name prodsnap-eda6-db
  fly postgres attach --app prodsnap-eda6 prodsnap-eda6-db

  fly postgres create --name prodsnap-eda6-staging-db
  fly postgres attach --app prodsnap-eda6-staging prodsnap-eda6-staging-db
  ```
